...
import { Inter, JetBrains_Mono, Barlow, IBM_Plex_Mono } from "next/font/google";
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="nl" className={`${inter.variable} ${mono.variable} ${barlow.variable} ${plex.variable}`}>
      <body>
